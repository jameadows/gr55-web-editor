...
export const GR55AddressMap = {
  ...
  patch: {
    ...
    pcmTone1: {
      ...
      partLevel: {
        address: 0x18002004, // Confirmed: scan shows 0x18002004=0x3F=63 ✓
        size: 1,
        type: 'number',
        range: [0, 127],
        label: 'Level',
      ...
      partOctaveShift: {
        address: 0x18002005, // Confirmed: scan shows 0x18002005=0x40=64=center ✓
        size: 1,
        type: 'number',
        range: [-3, 3],
        label: 'Octave Shift',
    ...
    pcmTone2: {
      ...
      muteSwitch: {
        address: 0x18002103, // +1 shift: mystery byte at +2, muteSwitch at +3
        size: 1,
        type: 'boolean',
        label: 'Mute Switch',
    ...
    // Roland GR-55 MIDI Implementation: confirmed via VController_v2 source + empirical scan
    // ═══════════════════════════════════════════════════════════════
